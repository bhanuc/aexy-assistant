...
**On hold (2026-09-24).** Capturing a sign-in from the pod is not being
built; `signin_decision` answers 501 and `signinCandidates` is always `[]`.
The shape below is kept for when the capture design is settled.
